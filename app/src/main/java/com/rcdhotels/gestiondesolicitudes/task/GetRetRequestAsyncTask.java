...
public class GetRetRequestAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public GetRetRequestAsyncTask(Context context, String date, int status) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        items = getRequestList(0, date, status);
        return null;
    }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        RequestRecyclerViewAdapter adapter = new RequestRecyclerViewAdapter((Activity) context, items);
