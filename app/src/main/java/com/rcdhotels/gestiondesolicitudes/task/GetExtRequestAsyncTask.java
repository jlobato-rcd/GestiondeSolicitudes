...
public class GetExtRequestAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public GetExtRequestAsyncTask(Context context, String dateFrom, String dateTo, int status, String stgeloc, String movestloc, String matType) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        items = getRequestList(1, dateFrom, dateTo, status, stgeloc, movestloc, matType);
        return null;
    }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        adapter = new ReqRecyclerViewAdapter((Activity) context, requestArrayList);
        ...
        adapter.setOnClickListener(new ReqRecyclerViewAdapter.OnClickListener() {
            ...
            public void onItemClick(View view, Request request, int pos) {
                if (adapter.getSelectedItemCount() > 0) {
                    ...
                    else if (user.getRole().equalsIgnoreCase("GS_REPRO") && request.getSTATUS() == 6) {
                        enableActionMode(pos);
                    }
                    else{
